...
export const createInitialBrokerServiceState = (cr: BrokerService): BrokerServiceFormState => {
...
export const createEmptyBrokerService = (namespace: string): BrokerService => ({
